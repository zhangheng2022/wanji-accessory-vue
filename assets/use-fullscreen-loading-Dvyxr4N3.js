import"./index-CbtdQ3nw.js";/* empty css                  *//* empty css                *//* empty css                   */import{a8 as m,h as _,k as g,E as u}from"./element-DKeIcv7k.js";import{t as f,v as E,L as n,D as a,I as c,x as y}from"./vue-jof-YVwm.js";import{_ as w}from"./plugin-vueexport-helper-DlAUqK2U.js";import"./vxe-ynyj-azH.js";const x={lock:!0,text:"加载中..."},p=(o,e={})=>{let r;return async(...i)=>{try{return r=m.service({...x,...e}),await o(...i)}finally{r.close()}}},v={code:0,data:{list:[]},message:"获取成功"};function C(o){return new Promise(e=>{setTimeout(()=>{e({...v,data:{list:o}})},1e3)})}function S(){return new Promise((o,e)=>{setTimeout(()=>{e(new Error("发生错误"))},1e3)})}const k={class:"app-container"},A=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
